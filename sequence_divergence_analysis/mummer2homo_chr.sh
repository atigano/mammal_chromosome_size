...
#SBATCH --output=mummer2homo_%j.log
#SBATCH --mem=100GB #MB
#make alignment
#mummer2homo_chr.sh
module purge
...
REF=$1
QUERY=$2
cd ~/20pero/divergence_homo/mummer_chr_genomes
nucmer --maxgap 2000 -p mummer2${REF}_${QUERY}_chr -t 24 --mincluster 1000 ~/20pero/divergence_homo/homo_genomes_chr/${REF}_chr.fa ~/20pero/divergence_homo/homo_genomes_chr/${QUERY}_chr.fa
