...
#SBATCH --output=mummer2pero_%j.log
#SBATCH --mem=100GB #MB
#make alignment
#mummer2pero_chr.sh
module purge
...
REF=$1
QUERY=$2
cd ~/20pero/divergence_pero/mummer_chr_genomes
nucmer --maxgap 2000 -p mummer2${REF}_${QUERY}_chr -t 24 --mincluster 1000 ~/20pero/divergence_pero/pero_genomes_chr/Peromyscus_${REF}_chr.fa ~/20pero/divergence_pero/pero_genomes_chr/Peromyscus_${QUERY}_chr.fa
